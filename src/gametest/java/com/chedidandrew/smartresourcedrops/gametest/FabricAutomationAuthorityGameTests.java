    ...
    public void fabricFakePlayerDeathRemainsVanillaOneX(final GameTestHelper helper) {
        ...
        try {
            if (!ConfigManager.update(config -> {
                ...
                throw new AssertionError("Could not configure Fabric automation authority test");
            }

            final FakePlayer automation = FakePlayer.get(
                    helper.getLevel(),
                    new GameProfile(
            ...
            if (!ConfigManager.update(config ->
                ...
                throw new AssertionError("Could not restore Fabric automation authority config");
            }
        }
        helper.succeed();
    }
