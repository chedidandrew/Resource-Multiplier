...
The unreleased shearing candidate uses schema 3. These settings form an independent 256-entry domain and do not consume the block or death-entity rule budgets.
