...
- Tag: `v1.3.2+mc1.21.2-1.21.3`
- Fabric asset: `smart-resource-multiplier-1.3.2+mc1.21.2-1.21.3.jar`
- NeoForge asset: `smart-resource-multiplier-neoforge-1.3.2+mc1.21.2-1.21.3.jar`
...
Never rename an older JAR: its embedded loader metadata and version would remain wrong. Upload the two JARs as separate CurseForge files with the correct loader and Minecraft 1.21.2–1.21.3 selections. Never install both loader files together.
