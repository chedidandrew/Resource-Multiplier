...
- On Minecraft 1.21.6-1.21.8, entity shearing multiplication is eligible only inside an identity-matched real-player or supported vanilla-dispenser scope and at the standard living-entity final loot-consumer boundary. A tag alone cannot make custom direct output eligible.
...
- Mooshroom, Snow Golem, and Bogged are protected special cases. Direct equipment ejection, beehives, leash removal, and block shearing are outside the entity-shearing scope.
