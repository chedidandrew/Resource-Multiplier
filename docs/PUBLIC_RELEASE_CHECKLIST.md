...
This checked record covers the separate Fabric and NeoForge releases for Minecraft 1.21.5. Minecraft 26.2 remains the newest/default release on `main`.

## Identity and compatibility

- [x] Both loader metadata files declare version `1.3.2+mc1.21.5`, Java 21, and only Minecraft 1.21.5.
...
- [x] GUI and placement-persistence gates pass.
...
- [x] The workflow permits only tag `v1.3.2+mc1.21.5` at the tip of `backport/1.21.5`.
