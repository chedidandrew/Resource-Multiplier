...
readonly CLIENT_PASS_MARKER='NeoForge multiplayer client smoke test passed: permissions, GUI authority, six channels, near-limit patch, oversized rejection, and reset'
readonly SERVER_PASS_MARKER='NeoForge multiplayer server smoke test passed: non-op, promotion, basic patch, near-limit patch, and reset'
