...
> **Branch release:** This source snapshot builds Smart Resource Multiplier `1.3.2` for Minecraft `1.19.2` on Fabric and Forge. Minecraft `26.2` remains the newest release and the default `main` branch.
