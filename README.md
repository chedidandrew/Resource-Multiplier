...
> **Branch release:** This source snapshot builds Smart Resource Multiplier `1.3.2` for Minecraft `26.1–26.1.2` on Fabric and NeoForge. Minecraft `26.2` remains the newest release and the default `main` branch.
