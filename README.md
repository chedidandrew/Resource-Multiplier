...
> **Minecraft 26.3 source:** `1.4.0-beta.1` ports both loaders while preserving the 1.3.0 gameplay and configuration. This beta is not a storefront release. See [26.3 validation and build instructions](docs/releases/1.4.0-beta.1.md).
