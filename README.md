...
<p align="center">
  ...
  <img alt="Minecraft 1.21.9-1.21.10 backport" src="https://img.shields.io/badge/Status-1.3.2%2Bmc1.21.9--1.21.10-Stable-2EA44F">
</p>

> [!IMPORTANT]
> **Current stable release:** Minecraft 26.2 remains the newest, default release on the `main` branch. This branch carries Smart Resource Multiplier `1.3.2` for Minecraft Java Edition 1.21.9-1.21.10. Fabric uses one shared file; NeoForge uses one exact file per Minecraft version.
...
Download the current release from [CurseForge](https://www.curseforge.com/minecraft/mc-mods/resource-multiplier). Source code and the dedicated 1.21.9-1.21.10 backport release are maintained on [GitHub](https://github.com/chedidandrew/Resource-Multiplier).

Choose exactly one file: `smart-resource-multiplier-1.3.2+mc1.21.9-1.21.10.jar` for Fabric, `smart-resource-multiplier-neoforge-1.3.2+mc1.21.9.jar` for NeoForge 1.21.9, or `smart-resource-multiplier-neoforge-1.3.2+mc1.21.10.jar` for NeoForge 1.21.10. Remove older copies first and never install Fabric and NeoForge files together.
...
| Mod loader | Fabric Loader 0.19.5+, NeoForge 21.9.16-beta for 1.21.9, or NeoForge 21.10.64 for 1.21.10 |
| Fabric API | 0.134.1+1.21.9 or a compatible newer target build; Fabric only |
| Java | 21 |
| Configuration-list integration | Mod Menu 16.0.1+ optional on Fabric; native Configure support on NeoForge |

1. Install Minecraft Java Edition 1.21.9 or 1.21.10.
...
- Supported vanilla and datapack-tagged standard shearables use the audited final-output path; special rewards continue to fail closed where they are not explicitly supported.
