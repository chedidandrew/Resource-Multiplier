...
> **Branch release:** This source snapshot builds Smart Resource Multiplier `1.3.2` for Minecraft `1.20.5–1.20.6` on Fabric and NeoForge. Minecraft `26.2` remains the newest release and the default `main` branch.
