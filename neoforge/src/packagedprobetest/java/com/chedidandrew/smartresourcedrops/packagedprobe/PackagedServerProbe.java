...
public final class PackagedServerProbe {
    ...
    private void onServerTick(final ServerTickEvent.Post event) {
        ...
        try {
            ...
            LOGGER.info(
                    "Packaged NeoForge server candidate Smart Resource Multiplier {} passed exact version, code-source, config, status, and validation checks",
                    System.getProperty("smart_resource_drops.expectedVersion", "1.3.2+mc1.20.6"));
